    ...
    <div class="wrap" id="aletheme-edit-slider-page">
        ...
        <div id="optionsframework-metabox" class="metabox-holder">
            <div id="optionsframework" class="postbox">
                ...
                <div class="page">
                    <b><i>Version 2.8 - 23.01.2016</i></b><br />
                    <p class="greycolor">
                        - Fixed Admin Menu blank page issue<br />
                        - Fixed Widgets error issue<br />
                        - Added an Import/Export tool<br />
                        - Added a new Demo Data content file for import tool.
                    </p>
                    <b><i>Version 2.7 - 02.04.2015</i></b><br />
                    <p class="greycolor">
                        - WooCommerce 2.3.7 ready. Fixed the issue with single item thumbnails slider<br />
                    </p>
